        ...
        {popularData.map((item) => (
          <SwiperSlide key={item.id}>
            <div
              ...
              className="w-full h-full flex justify-end items-end flex-col cursor-pointer transition-all duration-200 ease-in-out hover:shadow-md hover:shadow-fuchsia-900  bg-slate-950/30 rounded-md"
            >
              <img
                src={
