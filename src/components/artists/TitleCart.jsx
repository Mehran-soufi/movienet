...
function TitleCart({ trendingData, active, setActive }) {


  return (
    <div className="w-full flex justify-between items-center border-b border-slate-300 py-4">
      <div className="flex justify-start items-center md:gap-5 gap-2">
        <p className="sm:text-2xl text-xl text-slate-300">Artist Works</p>
